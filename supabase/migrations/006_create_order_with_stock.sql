-- Atomically create an order, insert its items and decrement product stock.
-- Run after 005_seed_product_stock.sql.

drop function if exists public.create_order_with_stock(jsonb, jsonb);
