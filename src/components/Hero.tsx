  ...
  return (
    <section className="relative isolate min-h-[calc(100svh-9rem)] overflow-hidden bg-[#efe7dc]">
      <Image
        ...
        alt="Akcesoria Pawly dla psów ułożone w jasnej sesji produktowej"
        fill
        priority
        sizes="100vw"
